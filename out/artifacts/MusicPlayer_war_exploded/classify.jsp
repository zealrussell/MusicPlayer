        ...
        <div>
            ...
            <div class="listSong">
                <c:forEach items="${mlist}" var="music" varStatus="pos">
                    ...
                    <div class="ls4">
                        <button class="fa fa-heartbeat" aria-hidden="true" id="cbtn" type="button" value="${music.id}">收藏</button>
                    </div>
                    <div class="ls5">
                        <a href="wav/BTS-MICDrop.wav" download="${music.name}">
                            <button class="fa fa-download" aria-hidden="true"id="dbtn" type="button" value="${download}"></button>
                        </a>
                    </div>
                </c:forEach>
            </div>
